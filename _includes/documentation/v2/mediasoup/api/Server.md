...
`logLevel`               | String  | Logging level for logs generated by the media worker subprocesses (check the [Debugging](/documentation/v2/mediasoup/debugging/) documentation). Valid values are "debug", "warn", "error". | No | "error"
