...
{: #ProducerHeaderExtensionOptions .code}

<div markdown="1" class="table-wrapper L3">

Field           | Type    | Description   | Required | Default
--------------- | ------- | ------------- | -------- | ---------
`absCaptureTime` | Boolean | Instructs the browser/device to include [abs-capture-time](https://www.ietf.org/archive/id/draft-ietf-avtcore-abs-capture-time-00.html) header extension in the RTP packets. | No | `false`.
