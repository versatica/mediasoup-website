...
{: #device-recvRtpCapabilities .code}

The device RTP capabilities for receiving media, generated by combining both the underlying WebRTC capabilities and the router RTP capabilities (see the [load()](#device-load) method).
...
{: #device-sendRtpCapabilities .code}

The device RTP capabilities for sending media, generated by combining both the underlying WebRTC capabilities and the router RTP capabilities (see the [load()](#device-load) method).
