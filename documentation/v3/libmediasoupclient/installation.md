...
libmediasoupclient makes use of Google's libwebrtc C++ library. Follow the official instructions to build it and make sure the branch `m79` is checked-out and compiled.
